                    ...
                    <div class="col-sm-6">
                      <label for="">Pisava napis/posvetilo 1</label>
                         <select class="form-control" id="exampleFormControlSelect1"  :style="{'font-family': font1}" v-model="font1">
                          <option style="font-family: 'Unicorn Sparkles'" value="Unicorn Sparkles">Pisava 1</option>
                          <option style="font-family: 'Bodoni'" value="Bodoni">Pisava 2</option>
                          <option style="font-family: 'Bodoni Italic'" value="Bodoni Italic">Pisava 3</option>
                          <option style="font-family: 'Queen Xylophia'" value="Queen Xylophia">Pisava 4</option>
                          <option style="font-family: 'Kiss Me or Not'" value="Kiss Me or Not">Pisava 5</option>
                          <option style="font-family: 'raustila'" value="raustila">Pisava 6</option>
                          <option style="font-family: 'I Love Glitter'" value="I Love Glitter">Pisava 7</option>
                        </select>
                    </div>
                </div>
                 <br />
