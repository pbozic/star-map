<template>
  <div class="home">
            ...
            <div class="tab-content" id="myTabContent">
              ...
              <div :class='["tab-pane fade", {"show active": selected_tab === "izgled"}]' id="izgled" role="tabpanel" aria-labelledby="izgled-tab">
                ...
                <div class="row" v-if="selected_product != null">
                  ...
                  <div class="col">
                    <div class="row">
                      <div :class="{'col-sm-3 col-4 barva': true, 'active': selected_color === color }" v-for="(color) of selected_product_variations.colors" :key="color" @click="selected_product_varaint = selected_product_variations.map[color]; selected_color = color; changes = true;">
    ...
    <div class="toasta" @click="scrollTop()" v-if="changes">
        Check changes
    </div>
  </div>
</template>
