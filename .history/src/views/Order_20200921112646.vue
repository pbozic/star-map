                     ...
                     <div class="row" v-if="selected_product.title == 'Umetniška zvezdna mapa'">
                        <div class="col">
                          ...
                          <div class="form-check">
                            <input type="radio" value="krog" class="form-check-input" @model="extra_design">
                            <label class="form-check-label" for="exampleCheck1">Krog</label>
                          </div>
                          <div class="form-check">
                            <input type="radio" value="krog2" class="form-check-input" @model="extra_design">
                            <label class="form-check-label" for="exampleCheck1">Dva kroga</label>
                          </div>
                          <div class="form-check">
                              <input type="radio" value="kvadrat" class="form-check-input" @model="extra_design">
