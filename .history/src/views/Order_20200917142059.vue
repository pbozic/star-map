            ...
            <div class="tab-content" id="myTabContent">
              <div :class='["tab-pane fade", {"show active": selected_tab === "trenutek"}]' id="trenutek" role="tabpanel" aria-labelledby="trenutek-tab">
                ...
                <div class="datum1">
                 <div class="row">
                    <div class="col-3">
                      <input class="form-control" type="text" placeholder="Dan"  v-model="day">
                    </div>
                    <div class="col-3">
                    ...
                    <div class="col-3">
                      <input class="form-control" type="text" placeholder="Leto" v-model="year">
                    </div>
                 </div>
                </div>
                ...
                <div class="datum1">
                 <div class="row">
                    <div class="col-3">
                      <input class="form-control" type="text" placeholder="Ura"  v-model="hour">
                    </div>
                    <div class="col-3">
                      <input class="form-control" type="text" placeholder="Ura"  v-model="minute">
                    </div>
                 </div>
                </div>
