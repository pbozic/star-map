            ...
            <div class="tab-content" id="myTabContent">
              ...
              <div :class='["tab-pane fade", {"show active": selected_tab === "izgled"}]' id="izgled" role="tabpanel" aria-labelledby="izgled-tab">
                ...
                <div class="row" v-if="selected_product != null">
                  ...
                  <div class="col">
                    <div class="row">
                      <div class="col-3 barva" v-for="(color,i) of selected_product_variations.colors" :key="color" @click="selected_product_varaint = selected_product_variations.map[color]">
                     ...
                     <div class="row" v-if="selected_product.title == 'Umetniška zvezdna mapa'">
                        <div class="col">
                          UMETNIŠKA (detajli){{extra_design}}
                          <div class="form-check">
                            <input type="radio" value="krog" class="form-check-input" v-model="extra_design">
                            <label class="form-check-label" for="exampleCheck1">Krog</label>
                          </div>
                          <div class="form-check">
                            <input type="radio" value="krog2" class="form-check-input" v-model="extra_design">
                            <label class="form-check-label" for="exampleCheck1">Dva kroga</label>
                          </div>
                          <div class="form-check">
                              <input type="radio" value="kvadrat" class="form-check-input" v-model="extra_design">
                              <label class="form-check-label" for="exampleCheck1">Kvadrat</label>
                            </div>
                        </div>
                      </div>
                  </div>
