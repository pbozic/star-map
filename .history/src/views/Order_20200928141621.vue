    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-3"></div>
         <div class="col"><StarMap ref="map" v-bind:font1="font1" v-bind:font2="font2" v-bind:text1="text1"  v-bind:text2="text2" v-bind:dateText="dateText" v-bind:extra_design="extra_design" v-bind:selected_type="selected_type" v-bind:color="selected_color"/></div>
         <div class="col-sm-3"></div>
      </div>
...
export default {
  ...
  methods: {
    ...
    selectProduct(product) {
        ...
        if (!this.isInViewport(this.$refs.map)) {
          this.changes = true;
        }
