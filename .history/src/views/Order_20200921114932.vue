            ...
            <div class="tab-content" id="myTabContent">
              ...
              <div :class='["tab-pane fade", {"show active": selected_tab === "izgled"}]' id="izgled" role="tabpanel" aria-labelledby="izgled-tab">
                ...
                <div class="row" v-if="selected_product != null">
                  ...
                  <div class="col">
                    <div class="row">
                      <div class="col-3 barva" v-for="(color) of selected_product_variations.colors" :key="color" @click="selected_product_varaint = selected_product_variations.map[color]">
