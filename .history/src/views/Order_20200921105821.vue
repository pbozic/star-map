            ...
            <div class="tab-content" id="myTabContent">
              ...
              <div :class='["tab-pane fade", {"show active": selected_tab === "izgled"}]' id="izgled" role="tabpanel" aria-labelledby="izgled-tab">
                ...
                <div class="row" v-if="selected_product == null">
                  <div class="col">
                    <div class="row">
                      <div class="col vrsta umetniska" v-for="product of products" :key="product.id" @click="this.selected_product = product">
                ...
                <div class="row" v-if="selected_product != null">
                  <div class="col">
                    <div class="row">
                      <div class="col vrsta umetniska" v-for="product of selected_product.variants" :key="product.id" @click="this.selected_product = product">
                        <img :src="product.selectedImage" alt="">
                        <div class="overlay">
                          <span>{{product.title}} <br /> {{product.price}}</span>
                        </div>
