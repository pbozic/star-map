                     ...
                     <div class="row" v-if="selected_product.title == 'Umetniška zvezdna mapa' || selected_product.title == 'Razlita zvezdna mapa'">
                        <div class="col">
                          ...
                          <div class="form-check">
                             ...
                             <div :class="{'col-sm-3 col-4 design': true, 'active': extra_design === 'krog' }" @click="extra_design = 'krog'">
                                <img src="/img/circle.png" alt="">
                            </div>
                              <div :class="{'col-sm-3 col-4 design': true, 'active': extra_design === 'krog2' }" @click="extra_design = 'krog2'">
                                <img src="/img/circle2.png" alt="">
                            </div>
                              <div :class="{'col-sm-3 col-4 design': true, 'active': extra_design === 'kvadrat' }" @click="extra_design = 'kvadrat'">
