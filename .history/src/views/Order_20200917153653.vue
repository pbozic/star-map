  ...
  <div class="home">
    <div class="container-fluid">
      <div class="row" style="height: 100vh">
          <div class="col-8">
           <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
              <li class="nav-item" role="presentation">
                <a :class="['nav-link', {'active': selected_tab === 'trenutek'}]" @click=" e => e.preventDefault()" id="trenutek-tab" data-toggle="tab" role="tab" aria-controls="home" aria-selected="true">1. Izberi Trenutek</a>
              </li>
              <li class="nav-item" role="presentation">
                <a :class="['nav-link', {'active': selected_tab === 'posvetilo'}]"  @click=" e => e.preventDefault()" id="posvetilo-tab" data-toggle="tab" role="tab" aria-controls="profile" aria-selected="false">2. Vpiši posvetilo</a>
              </li>
              <li class="nav-item" role="presentation">
                <a :class="['nav-link', {'active': selected_tab === 'izgled'}]" @click=" e => e.preventDefault()" id="izgled-tab" data-toggle="tab" role="tab" aria-controls="contact" aria-selected="false">3. Izberi Izgled</a>
              </li>
            </ul>
          ...
          <div class="col-4">
              <StarMap v-bind:text1="text1"  v-bind:text2="text2" v-bind:dateText="dateText" />
          </div>
      </div>
    </div>
