            ...
            <div class="tab-content" id="myTabContent">
              ...
              <div :class='["tab-pane fade", {"show active": selected_tab === "posvetilo"}]' id="posvetilo" role="tabpanel" aria-labelledby="posvetilo-tab">
                <div class="row">
                 ...
                 <textarea name="coment" id="coment" cols="30" rows="10" v-model="comment"></textarea>
                  <br />
                  <br />
                       ...
                       <div class="row">
                        <div class="col-3">
                          <h4 class="h4">Velikost</h4> 
                            <select class="form-control" id="exampleFormControlSelect1"  v-model="size">
                              <option :value="size" v-for="size of selected_product_variations.sizes" :key="size">{{size}}</option>
                            </select>
                      </div>
                      </div>
                  </div>
