                        ...
                        <div class="col">
                          ...
                          <div class="form-check">
                             ...
                             <div :class="{'col-sm-3 col-4 design': true, 'active': extra_design === 'krog' }" @click="extra_design = 'krog'">
                              ...
                              <div :class="{'col-sm-3 col-4 design': true, 'active': extra_design === 'krog2' }" @click="extra_design = 'krog'">
                                <img src="/img/circle2.png" alt="">
                            </div>
                              <div :class="{'col-sm-3 col-4 design': true, 'active': extra_design === 'kvadrat' }" @click="extra_design = 'krog'">
