                    ...
                    <div class="col-sm-6">
                      <label for="">Pisava napis/posvetilo 1</label>
                         <select class="form-control" id="exampleFormControlSelect1"  v-model="font1">
                          <option value="Januar">Font1</option>
                          <option value="Februar">Font2</option>
                          <option value="Marec">Font3</option>
                          <option value="April">Font4</option>
                          <option value="Junij">Font5</option>
                          <option value="Julij">Font6</option>
                        </select>
                    </div>
                </div>
                 <br />
