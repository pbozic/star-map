    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3"></div>
         <div class="col"><StarMap v-bind:font1="font1" v-bind:font2="font2" v-bind:text1="text1"  v-bind:text2="text2" v-bind:dateText="dateText" v-bind:extra_design="extra_design" v-bind:selected_type="selected_type"/></div>
         <div class="col-sm-3"></div>
      </div>
      <div class="row">
          <div class="col">
