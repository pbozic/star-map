            ...
            <div class="tab-content" id="myTabContent">
              <div :class='["tab-pane fade", {"show active": selected_tab === "trenutek"}]' id="trenutek" role="tabpanel" aria-labelledby="trenutek-tab">
                ...
                <div class="datum1">
                 <div class="row">
                  ...
                  <br>
                <br>
                 <label for="datum">Vpiši uro posebnega trenutka</label>
                <br>
                <br>
                <div class="datum1">
                 <div class="row">
                  ...
                  <br />
                  <br />
                <button :class="['next-button', {'disabled': this.location == null}]" @click="nextTab('posvetilo')">Next</button>
                <br />
                  <br />
              ...
              <div :class='["tab-pane fade", {"show active": selected_tab === "posvetilo"}]' id="posvetilo" role="tabpanel" aria-labelledby="posvetilo-tab">
                 ...
                 <div class="row">
                    <div class="col-6">
                      <label for="">Dodaj napis/posvetilo 1</label>
                      <input class="form-control" type="text" placeholder="Posvetilo 1"  v-model="font1">
                    </div>
                </div>
                 <div class="row">
                    <div class="col-6">
                      <label for="">Dodaj napis/posvetilo 2 (ni obvezno)</label>
                      <input class="form-control" type="text" placeholder="Posvetilo 1"  v-model="text2">
                    </div>
                </div>
                 <div class="row" v-if="text2 != null">
                    <div class="col-6">
                      <label for="">Dodaj napis/posvetilo 1</label>
                      <input class="form-control" type="text" placeholder="Posvetilo 1"  v-model="font2">
                    </div>
                </div>
  ...
  methods: {
    ...
    nextTab(tab) {
      if (tab.startsWith("posvetilo")) {
        ...
        this.text2 = this.getDateLocationText();
      }
