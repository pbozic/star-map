            ...
            <div class="tab-content" id="myTabContent">
              ...
              <div :class='["tab-pane fade", {"show active": selected_tab === "izgled"}]' id="izgled" role="tabpanel" aria-labelledby="izgled-tab">
                ...
                <div class="row">
                  <div class="col">
                    <div class="row">
                      <div :class="{'col-3 vrsta': true, 'active': selected_product.id === product.id }" v-for="product of products" :key="product.id" @click="selectProduct(product)">
                ...
                <div class="row" v-if="selected_product != null">
                  ...
                  <br />
                  <div class="controlls">
                     <button :class="['next-button', 'float-left']" @click="nextTab('posvetilo')">Nazaj</button>
