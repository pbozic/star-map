                      ...
                      for (let [i, chld] of grp.children.entries()) {
                        ...
                        if ("attributes" in c) {
                          if ("d" in c.attributes) {
                            ...
                            let node = rc.path(c.attributes.d, { roughness: 1.8, stroke: "red", bowing: 0.5, strokeWidth: 0.5});
