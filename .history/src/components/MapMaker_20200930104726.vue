...
export default {
  ...
  async mounted() {
    const result = await main({
      debug: true,
      command: 'convert http://localhost:8080/img/mask.png http://localhost:8080/img/ares.svg -compose luminize  -composite',
      inputFiles: [ 'http://localhost:8080/img/mask.png', 'http://localhost:8080/img/ares.svg' ]
    })
