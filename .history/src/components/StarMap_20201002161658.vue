...
//   padding: 35px;
    -webkit-box-shadow: inset -5px 9px 19px -12px rgba(0,0,0,0.75);
    -moz-box-shadow: inset -5px 9px 19px -12px rgba(0,0,0,0.75);
    box-shadow: inset -5px 9px 19px -12px rgba(0,0,0,0.75);
    margin-top: 50px;
    position: absolute;
    width: 283px;
    /* margin: 0 auto; */
