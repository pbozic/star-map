<template>
  <div class="star-map">
    ...
    <div class="text-area">
        <div v-resize-text class="text" :style="{'font-size': fontSize1()}" ref="posvetilo">
          {{text1 || "Napis 1"}}
        </div>

        <div v-resize-text class="text" :style="{'font-size': fontSize2()}" ref="malo">
          {{text2 || "Napis 2"}}
        </div>
        <div class="datum">
...
export default {
  ...
  methods: {
    fontSize1(el) {
      ...
      let element = this.$refs.posvetgilo;
