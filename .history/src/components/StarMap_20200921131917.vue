<template>
  <div class="okvir">
    <div class="star-map">
      <div :class='{"circle": extra_design == "krog" || extra_design == "krog2", "square": extra_design == "kvadrat"}'>
        
        
      </div>
      <div :class='{"map": true, "circle": extra_design == "krog" || extra_design == "krog2", "square": extra_design == "kvadrat"}'>
...
.okvir {
  ...
  border-width:80px;
  border-image: url("../assets/images/okvir.png") 30px 30px 30px 30px repeat;
}
.location {
  margin:0px auto;
  width: 50%;
