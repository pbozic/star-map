<template>
  <div class="okvir">
    <div :class="{'star-map': true, [selected_type]: true, [color_mapped]: true,}">
      ...
      <div class="text-area">
          <div class="text" :style="{'font-family': font1 || 'Quattrocento Sans', 'font-size': fon1_size}" ref="posvetilo">
            {{text1 || "Primer posvetilo 1"}}
          </div>

          <div class="text" :style="{'font-family': font2 || 'Quattrocento Sans', 'font-size': fon1_size}" ref="malo">
            {{text2}}
          </div>
          <div class="datum">
