                ...
                if ("id" in grp.attributes) {
                  if (grp.attributes.id === "constLines") {
                    console.log(grp);
                      ...
                      let a = stringify(grp);
                      console.log(a)
                     svg2roughjs.svg = loadSvgString(`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="300" height="300">${a}</svg>`);
                  } else {
                    delete json[grp]
                  }
                }
