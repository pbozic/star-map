...
export default {
  ...
  methods: {
    async getLocation() {
      axios.get(`https://us1.locationiq.com/v1/search.php?key=pk.4648c2b6ecdd58446110e10f87dcfbd6&q=${this.naslov}&format=json`);
  ...
  form: true,         // Display form for interactive settings. Needs a div with
      geopos: null,                // id="celestial-form", created automatically if not present
