                      ...
                      for (let [i, chld] of grp.children.entries()) {
                        ...
                        if ("attributes" in c) {
                          if ("d" in c.attributes) {
                            ...
                            let node = rc.path(c.attributes.d, { roughness: 1.3, stroke: "red", bowing: 4, strokeWidth: 0.5});  
                          consts = consts.concat(Array.from(node.childNodes));
