...
#celestial-form #datepick { position:relative; display:inline-block; _vertical-align:-8px; top:7px; left:-31px; width:28px; height:24px; border:0px none; border-left:1px solid #ccc; background-color: #f7f7f7; background-image: url('./assets/images/dtpick.png'); background-position: -45px 1px; cursor:default; }
...
#celestial-date #left, #celestial-date #right { display:inline-block; width:12px; height:24px; margin:0; vertical-align:-8px; cursor:pointer;  background-image: url('./assets/images/dtpick.png'); }
#celestial-form #day-left, #celestial-form #day-right { display:inline-block; float:none; width:12px; height:24px; margin:0; padding:0; vertical-align:middle; cursor:pointer; border: 0 none; background-color:transparent; background-image: url('./assets/images/dtpick.png'); }
...
@font-face {
    ...
    src: url('./assets/fonts/UnicornSparkles.woff2') format('woff2'),
        url('./assets/fonts/UnicornSparkles.woff') format('woff');
    font-weight: normal;
    font-style: normal;
    font-display: swap;
}
...
@font-face {
    font-family: 'Bodoni';
    src: url('./assets/fonts/BodoniBT-Book.woff2') format('woff2'),
        url('./assets/fonts/BodoniBT-Book.woff') format('woff');
    font-weight: normal;
    font-style: normal;
    font-display: swap;
}
...
@font-face {
    font-family: 'Queen Xylophia';
    src: url('./assets/fonts/QueenXylophia-Regular.woff2') format('woff2'),
        url('./assets/fonts/QueenXylophia-Regular.woff') format('woff');
    font-weight: normal;
    font-style: normal;
    font-display: swap;
}
...
@font-face {
    ...
    src: url('./assets/fonts/BodoniBT-BookItalic.woff2') format('woff2'),
        url('./assets/fonts/BodoniBT-BookItalic.woff') format('woff');
    font-weight: normal;
    font-style: italic;
    font-display: swap;
}
...
@font-face {
    ...
    src: url('./assets/fonts/KissMeorNot.woff2') format('woff2'),
        url('./assets/fonts/KissMeorNot.woff') format('woff');
    font-weight: normal;
    font-style: normal;
    font-display: swap;
}
...
@font-face {
    ...
    src: url('./assets/fonts/raustila-Regular.woff2') format('woff2'),
        url('./assets/fonts/raustila-Regular.woff') format('woff');
    font-weight: normal;
    font-style: normal;
    font-display: swap;
}
...
@font-face {
    ...
    src: url('./assets/fonts/ILoveGlitter.woff2') format('woff2'),
        url('./assets/fonts/ILoveGlitter.woff') format('woff');
    font-weight: normal;
    font-style: normal;
    font-display: swap;
}
...
@font-face {
    ...
    src: url('./assets/fonts/Nouradilla.woff2') format('woff2'),
        url('./assets/fonts/Nouradilla.woff') format('woff');
    font-weight: normal;
    font-style: normal;
    font-display: swap;
}
