...
@font-face {
    ...
    src: url('./src/assets/fonts/UnicornSparkles.woff2') format('woff2'),
        url('./src/assets/fonts/UnicornSparkles.woff') format('woff');
    font-weight: normal;
    font-style: normal;
    font-display: swap;
}
...
@font-face {
    ...
    src: url('./src/assets/fonts/BodoniBT-Book.woff2') format('woff2'),
        url('./src/assets/fonts/BodoniBT-Book.woff') format('woff');
    font-weight: normal;
    font-style: normal;
    font-display: swap;
}
...
@font-face {
    ...
    src: url('./src/assets/fonts/QueenXylophia-Regular.woff2') format('woff2'),
        url('./src/assets/fonts/QueenXylophia-Regular.woff') format('woff');
    font-weight: normal;
    font-style: normal;
    font-display: swap;
}
...
@font-face {
    font-family: 'Bodoni Bk BT';
    src: url('./src/assets/fonts/BodoniBT-BookItalic.woff2') format('woff2'),
        url('./src/assets/fonts/BodoniBT-BookItalic.woff') format('woff');
    font-weight: normal;
    font-style: italic;
    font-display: swap;
}
...
@font-face {
    ...
    src: url('./src/assets/fonts/KissMeorNot.woff2') format('woff2'),
        url('./src/assets/fonts/KissMeorNot.woff') format('woff');
    font-weight: normal;
    font-style: normal;
    font-display: swap;
}
...
@font-face {
    ...
    src: url('./src/assets/fonts/raustila-Regular.woff2') format('woff2'),
        url('./src/assets/fonts/raustila-Regular.woff') format('woff');
    font-weight: normal;
    font-style: normal;
    font-display: swap;
}
...
@font-face {
    ...
    src: url('./src/assets/fonts/ILoveGlitter.woff2') format('woff2'),
        url('./src/assets/fonts/ILoveGlitter.woff') format('woff');
    font-weight: normal;
    font-style: normal;
    font-display: swap;
}
